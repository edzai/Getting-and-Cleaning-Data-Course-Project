theo3.model= ' Product_Knowledge =~ PK_S1+PK_S2+PK_S3+PK_S4

1.Collect and merge the data

setwd("C:/Users/Edzai/Desktop/coursera/getting and cleaning data/week 3/getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset")
library(plyr)
library(data.table)
